    ...
    <footer className="bg-gray-900 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-gray-400 leading-relaxed max-w-xs mb-6">
              Crafting unforgettable journeys across India&apos;s most
              spectacular landscapes since 2014. Your adventure starts here.
            </p>
            {/* Social icons */}
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full border border-gray-700 flex items-center justify-center hover:border-gray-400 transition-colors group"
                >
                  <svg
                    className="w-4 h-4 text-gray-400 group-hover:text-white transition-colors fill-current"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                  >
                    {social.icon}
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-gray-500">
          <p>© {new Date().getFullYear()} Hansvahini Expeditions. All rights reserved.</p>
          <p>Made with ♥ for every traveller</p>
        </div>
      </div>
    </footer>
  )
